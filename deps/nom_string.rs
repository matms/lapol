// =============================================================================
//
// Downloaded copy of "nom/examples/string.rs"
//
// Changes indicated <<< LIKE SO >>>.
//
...
// <<< USE of JEMALLOCATOR REMOVED >>>
// Substituted &str with Span
    ...
    E: ParseError<Span<'a>> + FromExternalError<Span<'a>, std::num::ParseIntError>,
{
    alt((
        ...
        // of that parser.
        map(parse_literal, |s| StringFragment::Literal(s.fragment())),
...
pub(super) fn parse_string<'a, E>(input: Span<'a>) -> IResult<Span<'a>, String, E>
where
    E: ParseError<Span<'a>> + FromExternalError<Span<'a>, std::num::ParseIntError>,
{
